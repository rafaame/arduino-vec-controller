...
#define RELAY_VENTILATOR_SPEED_1  RELAY_3
#define RELAY_VENTILATOR_SPEED_2  RELAY_2
#define RELAY_VENTILATOR_SPEED_3  RELAY_1
#define RELAY_VENTILATOR_SPEED_4  RELAY_0
#define RELAY_AIR_CONDITIONING_1  RELAY_10
#define RELAY_AIR_CONDITIONING_2  RELAY_11
#define RELAY_AIR_RECIRCULATION_1 RELAY_12
#define RELAY_AIR_RECIRCULATION_2 RELAY_13
#define RELAY_HAZARD_LIGHTS_1     RELAY_14
#define RELAY_HAZARD_LIGHTS_2     RELAY_15
#define RELAY_DOOR_LOCKS          RELAY_8
#define RELAY_DEFROST             RELAY_9
#define RELAY_TRUNK               RELAY_4

#define RELAY_CHARGE_BATTERY      RELAY_16

#define VENTILATOR_POSITION_MOTOR_ID             0
#define VENTILATOR_POSITION_MOTOR_PINS           (const uint8_t[]) {46, 48}
#define VENTILATOR_POSITION_MOTOR_SPEED_PIN		 44
